...
`https://gitlab.com/api/v4/projects/{CI_PROJECT_ID}/packages/generic/enowsw/contactholder/{BranchName_or_Tag}/{Platform}/{toolset}/Enow_ContactHolder-{ProjectVersion}.{PackageExtension}`,
