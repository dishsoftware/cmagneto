...
#if defined(LIB_DISH_CONTACTHOLDER_CONTACTS_FIELDS_PHONENUMBERFORMATTER_SHARED)
    #if defined(DISH_CONTACTHOLDER_CONTACTS_FIELDS_PHONENUMBERFORMATTER_EXPORTS) || defined(Dish_ContactHolder_Contacts_fields_PhoneNumberFormatter_EXPORTS)
        #if defined(_WIN32)
            #if defined(__GNUC__)
