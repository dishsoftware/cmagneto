...
It seems, it is a bug in in GCC/GCOV (GCOV is called by LCOV under the hood)."
    ...
    def __verifyGeneratedLinuxPackages(self, iBuildType: BuildType) -> None:
        ...
        deploymentEntriesByMode = self.__loadExternalSharedLibraryDeploymentEntries(iBuildType)
    ...
    def __loadExternalSharedLibraryDeploymentEntries(self, iBuildType: BuildType) -> dict[ExternalSharedLibraryInstallMode, tuple[_ExternalSharedLibraryDeploymentEntry, ...]]:
        """Loads imported shared-library deployment expectations generated by the CMake setup stage."""
