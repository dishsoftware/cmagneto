...
class BuildRunner:
    ...
    CMagnetoInternal__RUN_TESTS__SCRIPT_NAME_WE = "run_tests"
    CMagnetoInternal__BUILD_SUMMARY__FILE_NAME = "build_summary.txt"
    CMagnetoInternal__TEST_BUILD_SUMMARY__FILE_NAME = "test_build_summary.txt"
    CMagnetoInternal__TEST_REPORT__FILE_NAME = "test_report.xml"
    ...
    def isBuildSummaryExistForBuildType(self, iBuildType: BuildType) -> bool:
        ...
        buildSummaryFilePath = os.path.join(self.summaryDirForBuildType(iBuildType), BuildRunner.CMagnetoInternal__BUILD_SUMMARY__FILE_NAME)
    ...
    def isCompiledTestsFileExistForBuildType(self, iBuildType: BuildType) -> bool:
        ...
        compiledTestsFilePath = os.path.join(self.summaryDirForBuildType(iBuildType), BuildRunner.CMagnetoInternal__TEST_BUILD_SUMMARY__FILE_NAME)
    ...
    def _runTests(self, iBuildType: BuildType) -> None:
        ...
        run_tests__scriptName = BuildRunner.FIND_IN_DIR_FILE_WITH_NAME_WE(run_tests__scriptDir, BuildRunner.CMagnetoInternal__RUN_TESTS__SCRIPT_NAME_WE)
        if run_tests__scriptName is None:
            warning(f"Script \"{BuildRunner.CMagnetoInternal__RUN_TESTS__SCRIPT_NAME_WE}\" not found in \"{run_tests__scriptDir}\". Tests have not been run. Call CMagneto__set_up__run_tests__script() in the root CMakeLists.txt to set up the script.")
        else:
    ...
    def isTestReportExistForBuildType(self, iBuildType: BuildType) -> bool:
        ...
        testReportFilePath = os.path.join(self.summaryDirForBuildType(iBuildType), BuildRunner.CMagnetoInternal__TEST_REPORT__FILE_NAME)
...
Artifact of {BuildRunner.BuildStage.Compile.name} stage is a \"{BuildRunner.CMagnetoInternal__BUILD_SUMMARY__FILE_NAME}\".\n\
Artifact of {BuildRunner.BuildStage.CompileTests.name} stage is a \"{BuildRunner.CMagnetoInternal__TEST_BUILD_SUMMARY__FILE_NAME}\".\n\
Artifact of {BuildRunner.BuildStage.RunTests.name} stage is a \"{BuildRunner.CMagnetoInternal__TEST_REPORT__FILE_NAME}\".\n\
...
Note: {BuildRunner.BuildStage.CompileTests.name} stage does not check, whether {BuildRunner.BuildStage.Compile.name} stage was rerun;\n\
     \"{BuildRunner.CMagnetoInternal__TEST_REPORT__FILE_NAME}\" is not deleted automatically, if tests are recompiled.\n\
