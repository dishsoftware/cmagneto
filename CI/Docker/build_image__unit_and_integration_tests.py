...
DOCKERFILE_PATH = str(Path(__file__).parent / "Dockerfile.unit_and_integration_tests")
DOCKERIMAGE_NAME = "unit_and_integration_tests"
DOCKERIMAGE_VER  = "1.0.0"
DOCKERIMAGE_TAG  = f"{DOCKERIMAGE_NAME}:{DOCKERIMAGE_VER}"
DOCKERIMAGE_DESCRIPTION = "For running unit and integration tests of the CMagneto code itself. Not of seed or test projects."
